...
\begin{document}
	...
	\begin{table}[H]
		...
		\begin{tabularx}{\textwidth}{lX}
			...
			\midrule
			\textbf{Blanco model effective parameters\footnotemark} & \textbf{For calibration curve calculations (95\% CI):} \\
			Effective grid period $P_{\text{eff}}$ & $15.50 \pm 0.05$~$\mu$m \\
			Effective strip width $D_{\text{eff}}$\footnotemark & $5.66 \pm 0.24$~$\mu$m \\
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.36\textwidth]{fig0_1}
		\vspace{-0.5em}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.78\textwidth]{passport_calibration}
		\vspace{-0.5em}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.34\textwidth]{passport_error}
		\vspace{-0.5em}
