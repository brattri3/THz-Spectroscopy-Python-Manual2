...
\begin{document}
	...
	\begin{minipage}[t]{0.44\textwidth}
		\vspace{0pt}
		\centering
		\includegraphics[width=\textwidth]{fig0_1}
		\vspace{-0.6em}
		\captionof{figure}{Experimental setup scheme with angles $\theta_1$ and $\theta_2$.}
		\label{fig:scheme}
	\end{minipage}
	...
	\begin{enumerate}[leftmargin=0.8cm, label=\Alph*., itemsep=1pt, parsep=0pt]
	...
	\begin{minipage}[t]{0.40\textwidth}
		...
		\vspace{-0.6em}
		\captionof{figure}{Attenuation error $\Delta A$ as a function of the rotator angle under backlashes $\Delta\theta = 0.5^\circ$ and $1.0^\circ$.}
		\label{fig:error}
	\end{minipage}
