# =====================================================================
# ВАРИАНТ 1. ГЛАВА 3: Прямая загрузка и визуализация (без базы данных)
# =====================================================================
# Чтобы запустить этот вариант, раскомментируй код ниже (и закомментируй Вариант 2):
#
# import config
...
#
# def main():
#     # 1. Загрузка экспериментальных данных вручную
...
# =====================================================================
# ВАРИАНТ 2. ГЛАВА 4: Пакетная загрузка в базу данных и выборка
# =====================================================================
# Этот вариант активен по умолчанию. Он также включает решение мини-задания Гл. 4.
